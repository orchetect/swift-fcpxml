...
extension FCPXML.ElementContext {
    ...
    public struct Tools {
        ...
        public var effectiveFormat: FCPXML.Format? {
        ...
        public var parentType: FCPXML.ElementType? {
        ...
        public func parentAbsoluteStartAsTimecode(
            ...
            guard let parentAbsoluteStart else { return nil }
            return try? element._fcpTimecode(
        ...
        public func parentAbsoluteEndAsTimecode(
            ...
            guard let parentAbsoluteEnd else { return nil }
            return try? element._fcpTimecode(
        ...
        public func parentDurationAsTimecode(
            ...
            guard let parentDuration else { return nil }
            return try? element._fcpTimecode(
        ...
        public func localRoles(includeDefaultRoles: Bool) -> [FCPXML.AnyRole] {
            ...
            if includeDefaultRoles, let elementType {
                elementRoles = FCPXML.addDefaultRoles(for: elementType, to: elementRoles)
            }
        ...
        public var inheritedRoles: [FCPXML.AnyInterpolatedRole] {
        ...
        public var metadata: [FCPXML.Metadata.Metadatum] {
        ...
        public var occlusion: FCPXML.ElementOcclusion {
        ...
        public var effectiveOcclusion: FCPXML.ElementOcclusion {
        ...
        public func format(for resource: XMLElement) -> FCPXML.Format? {
        ...
        public func ancestorEvent() -> FCPXML.Event? {
        ...
        public func ancestorProject() -> FCPXML.Project? {
        ...
        public func ancestorSequence() -> FCPXML.Sequence? {
        ...
        public var mediaRep: FCPXML.MediaRep? {
