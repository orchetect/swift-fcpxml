...
extension FCPXML.Sequence {
    public init(
        spine: FCPXML.Spine = .init(),
        audioLayout: FCPXML.AudioLayout? = nil,
        audioRate: FCPXML.AudioRate? = nil,
...
extension FCPXML.Sequence: FCPXMLElementMediaAttributes { }

extension FCPXML.Sequence {
    // only exists on sequence
    public var audioLayout: FCPXML.AudioLayout? {
        get {
...
extension FCPXML.Sequence: FCPXMLElementNoteChild { }

extension FCPXML.Sequence: FCPXMLElementMetadataChild { }
