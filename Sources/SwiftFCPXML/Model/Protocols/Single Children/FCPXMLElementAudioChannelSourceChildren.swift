...
public protocol FCPXMLElementAudioChannelSourceChildren: FCPXMLElement {
    ...
    var audioChannelSources: LazyFCPXMLChildrenSequence<FCPXML.AudioChannelSource> { get nonmutating set }
}

extension FCPXMLElementAudioChannelSourceChildren {
    public var audioChannelSources: LazyFCPXMLChildrenSequence<FCPXML.AudioChannelSource> {
...
extension XMLElement {
    ...
    public var fcpAudioChannelSources: LazyFCPXMLChildrenSequence<FCPXML.AudioChannelSource> {
