...
extension FCPXML.Root {
    ...
    public var resourcesDict: [String: XMLElement] {
        ...
        nonmutating set {
            ...
            let resourcesContainer = XMLElement(name: FCPXML.ElementType.resources.rawValue)
    ...
    public var library: FCPXML.Library? {
    ...
    public var projects: LazyFCPXMLChildrenSequence<FCPXML.Project> {
