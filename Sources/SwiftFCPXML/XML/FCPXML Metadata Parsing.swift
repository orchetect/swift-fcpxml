...
extension XMLElement {
    ...
    /// metadata `key`.
    func _fcpMetadataChild(forKey key: FCPXML.Metadata.Key) -> XMLElement? {
...
extension XMLElement {
    ...
    func _fcpMetadataChildStringValue(forKey key: FCPXML.Metadata.Key) -> String? {
...
extension XMLElement {
    ...
    func _fcpMetadataChildStringArrayValue(
        forKey key: FCPXML.Metadata.Key
    ) -> [String]? {
