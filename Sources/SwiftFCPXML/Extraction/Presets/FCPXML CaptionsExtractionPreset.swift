...
extension FCPXMLExtractionPreset where Self == FCPXML.CaptionsExtractionPreset {
    /// FCPXML extraction preset that extracts closed captions.
    public static var captions: FCPXML.CaptionsExtractionPreset {
        FCPXML.CaptionsExtractionPreset()
    }
}
