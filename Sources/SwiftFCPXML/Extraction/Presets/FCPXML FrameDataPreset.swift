...
extension FCPXML {
    ...
    public struct FrameDataPreset: FCPXMLExtractionPreset {
        ...
        ) async -> FCPXML.ExtractedFrameData {
...
extension FCPXMLExtractionPreset where Self == FCPXML.FrameDataPreset {
    /// FCPXML extraction preset that extracts data for each frame.
    public static var frameData: FCPXML.FrameDataPreset {
        FCPXML.FrameDataPreset()
    }
}
