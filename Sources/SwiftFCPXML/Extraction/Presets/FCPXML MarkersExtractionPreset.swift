...
extension FCPXMLExtractionPreset where Self == FCPXML.MarkersExtractionPreset {
    /// FCPXML extraction preset that extracts markers.
    public static var markers: FCPXML.MarkersExtractionPreset {
        FCPXML.MarkersExtractionPreset()
    }
}
...
extension FCPXML {
    ...
    public struct ExtractedMarker: FCPXMLExtractedModelElement, @unchecked Sendable {
        ...
        public var configuration: FCPXML.Marker.Configuration {
            model.configuration
        }
