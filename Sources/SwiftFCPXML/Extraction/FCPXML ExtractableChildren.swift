...
extension FCPXML.ExtractableChildren: Sendable { }

// MARK: - Static Constructors

extension FCPXML.ExtractableChildren {
...
extension FCPXML.ExtractableChildren.DirectChildren: @unchecked Sendable { }

extension FCPXML.ExtractableChildren {
    struct Descendant {
        let element: XMLElement
        let children: FCPXML.ExtractableChildren?
    }
}

// TODO: XMLElement is not Sendable
extension FCPXML.ExtractableChildren.Descendant: @unchecked Sendable { }
...
extension FCPXML.ExtractableChildren {
    init?(
        ...
        mcClipAngleMask: FCPXML.MCClip.AngleMask // = .active
    ) {
        ...
        case .mcClip: 
            ...
            var descendants: [FCPXML.ExtractableChildren.Descendant] = []
            ...
            let ec = FCPXML.ExtractableChildren(
                children: .all,
