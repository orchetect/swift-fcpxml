//
//  FCPXML StandaloneRefClip.swift
...
@Suite
struct FCPXML_StandaloneRefClip: TestUtils {
    // MARK: - Test Data

    var fileContents: Data {
        get throws {
            try TestResource.FCPXMLExports.standaloneRefClip.data()
        }
    }
    ...
    func extract() async throws {
        ...
        guard case let .refClip(refClip) = anyTimeline else { Issue.record(); return }
