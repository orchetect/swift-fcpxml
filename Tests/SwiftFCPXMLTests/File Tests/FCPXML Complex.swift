...
@Suite
struct FCPXML_Complex: TestUtils {
    // MARK: - Test Data
    ...
    let r2MediaRep: FCPXML.MediaRep = {
        let urlString = "file:///Volumes/Workspace/Dropbox/_coding/MarkersExtractor/FCP/Media/Nature%20Makes%20You%20Happy.mp4"
        let url = URL(string: urlString)!

        let bookmark = ""
    ...
    lazy var r2 = FCPXML.Asset(
        ...
        start: .zero,
        duration: Fraction(142_040, 1000),
        format: "r1",
    ...
    let r3MediaRep: FCPXML.MediaRep = {
        let urlString = "file:///Volumes/Workspace/Dropbox/_coding/MarkersExtractor/FCP/Media/Interstellar%20Soundtrack%20-%20No%20Time%20for%20Caution.wav"
        let url = URL(string: urlString)!

        let bookmark = ""
    ...
    lazy var r3 = FCPXML.Asset(
        ...
        start: .zero,
        duration: Fraction(10_860_590, 44100),
        format: nil,
    ...
    enum MarkerDuration {
        ...
        var duration: Timecode {
            switch self {
            case .frame:
                tc("00:00:00:01", .fps25)
            case .audioSample:
                // even though Final Cut Pro shows 44.1kHz as the audio sample rate for these clips,
                // the XML is using 48kHz as the rational fraction denominator to define the marker
                // length
                try! Timecode(
                    .samples(1, sampleRate: 48000),
                    at: .fps25,
                    base: .max80SubFrames
                )
            }
...
//        // shallow at clip level, there are more in nested title clips
//        #expect(element2Markers.count == 6)
//
...
//    }
    ...
    func extractMarkers() async throws {
        ...
        for md in Self.markerData {
            guard let em = extractedMarkers
                .first(where: { $0.element.fcpAsMarker?.name == md.name })
            else {
            ...
            #expect(
                em.value(forContext: .parentAbsoluteStartAsTimecode()) == md.clip.absoluteStart,
                "\(md.name)"
            )
            #expect(
                em.value(forContext: .parentDurationAsTimecode()) == md.clip.duration,
                "\(md.name)"
            )
...
extension FCPXML_Complex {
    ...
    @Test
    mutating func parseFormat_AssetClip() throws {
        // test data
    ...
    @Test
    mutating func parseFormat_AssetClip_Isolated() throws {
        // test data
        let clip = try XMLElement(xmlString: """
            <asset-clip ref="r2" offset="0s" name="Nature Makes You Happy" duration="355100/2500s" tcFormat="NDF" audioRole="dialogue">
            </asset-clip>
        ...
        // asset clip's ref r2 is an asset resource which in turn uses format r1, and asset clip
        // contains its own tcFormat
        #expect(clip._fcpFirstFormatResourceForElementOrAncestors(in: resources) == r1)
    }
    ...
    @Test
    mutating func parseFormat_AssetClip_Deep() throws {
        // test data
        ...
        // to succeed, this would need to continue traversing ancestors when it encountered the
        // undefined r4 format,
        ...
        // ref r2 is an asset resource containing video and audio. it has a format attribute with
        // value "r1".
    ...
    @Test
    mutating func parseDefinedFormat_AssetClip_Deep() throws {
        // test data
        let innerClip = try XMLElement(xmlString: """
            <asset-clip ref="r3" lane="-1" offset="0s" name="Interstellar Soundtrack - No Time for Caution" duration="177315755/720000s" format="r4" audioRole="dialogue">
                <audio-channel-source srcCh="1, 2" role="music.music-1"/>
    ...
    @Test
    mutating func parseFrameRate_VideoClip() throws {
        // test data
        let clip = try XMLElement(xmlString: """
        ...
        // video clip's ref r7 doesn't contain any info, so it needs to traverse ancestors to find
        // r1 in sequence
    ...
    @Test
    mutating func parseFrameRate_VideoClip_Isolated() throws {
        // test data
        let clip = try XMLElement(xmlString: """
            <video ref="r7" offset="869600/2500s" name="Clouds" start="3600s" duration="250300/2500s" role="Sample Role.Sample Role-1">
            </video>
    ...
    @Test
    mutating func parseFormat_VideoClip() throws {
        // test data
        let clip = try XMLElement(xmlString: """
            <video ref="r7" offset="869600/2500s" name="Clouds" start="3600s" duration="250300/2500s" role="Sample Role.Sample Role-1">
            </video>
    ...
    @Test
    func parseTCFormat_VideoClip() throws {
        // test data
        let clip = try XMLElement(xmlString: """
            <video ref="r7" offset="869600/2500s" name="Clouds" start="3600s" duration="250300/2500s" role="Sample Role.Sample Role-1">
            </video>
