...
struct FCPXML_25i: TestUtils {
    ...
    let r2MediaRep = FCPXML.MediaRep(
        ...
        src: URL(
            string: "file:///Users/user/Desktop/Marker_Interlaced.fcpbundle/11-9-22/Original%20Media/Test%20Video%20(29.97%20fps).mp4"
        )!,
        bookmark: nil
    )
    ...
    lazy var r2 = FCPXML.Asset(
        ...
        start: .zero,
        duration: Fraction(101_869, 1000),
        format: "r3",
