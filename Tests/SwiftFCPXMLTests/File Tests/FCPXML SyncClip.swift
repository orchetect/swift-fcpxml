...
@Suite
struct FCPXML_SyncClip: TestUtils {
    // MARK: - Test Data
    ...
    func extractMarkers_MainTimeline() async throws {
        ...
        #expect(try marker.value(forContext: .inheritedRoles) == [
            .inherited(#require(.video(raw: "Sample Role"))), // markers can never have 'assigned' roles
            .inherited(#require(.audio(raw: "effects.effects-1"))) // markers can never have 'assigned' roles
        ])
    }
    ...
    func extractMarkers_Deep() async throws {
        ...
        #expect(try marker0.value(forContext: .inheritedRoles) == [
            .inherited(#require(.video(raw: "Sample Role"))), // markers can never have 'assigned' roles
            .inherited(#require(.audio(raw: "effects.effects-1"))) // markers can never have 'assigned' roles
        ])
        ...
        #expect(try marker1.value(forContext: .inheritedRoles) == [
            .inherited(#require(.video(raw: "Sample Role"))), // markers can never have 'assigned' roles
            .inherited(#require(.audio(raw: "music.music-1"))) // markers can never have 'assigned' roles
        ])
        ...
        #expect(try marker2.value(forContext: .inheritedRoles) == [
            .inherited(#require(.video(raw: "Sample Role"))), // markers can never have 'assigned' roles
            .inherited(#require(.audio(raw: "effects.effects-1"))) // markers can never have 'assigned' roles
        ])
    }
