...
@Suite struct FinalCutPro_FCPXML_59_94: FCPXMLUtilities {
    // MARK: - Test Data
    ...
    func parse() async throws {
        ...
        #expect(sequence.durationAsTimecode() == Self.tc("00:04:23:25", projectFrameRate))
